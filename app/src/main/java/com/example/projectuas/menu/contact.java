...
import com.example.projectuas.user.UserItem;
import com.example.projectuas.user.UsersRecyclerAdapter;
       ...
       // FirebaseDatabase.getInstance().setPersistenceEnabled(true);
        ...
        buttonAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                viewDialogAdd.showDialog(contact.this);
            }
        });
        readData();
    }
    ...
    private void readData() {
        ...
        databaseReference.child("USERS").orderByChild("userName").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter =new UsersRecyclerAdapter(contact.this,usersItemArrayList);
            ...
            buttonAdd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(name.isEmpty()|| email.isEmpty()||country.isEmpty()){
                        ...
                        databaseReference.child("USERS").child(id).setValue(new UserItem(id,name,email,Gender,Age,country));
