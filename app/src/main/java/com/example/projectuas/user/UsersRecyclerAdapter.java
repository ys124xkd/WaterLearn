...
public class UsersRecyclerAdapter extends RecyclerView.Adapter<UsersRecyclerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.buttonUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                viewDialogUpdate.showDialog(context, users.getUserID(),users.getUsername(),users.getUserEmail(),users.getGender(),users.getAge(),users.getUserCountry());
            }
        });
    ...
    public class ViewDialogUpdate{
        public void showDialog(Context context,String id,String name,String email,String Gender, String Age, String Country){
            ...
            buttonUpdate.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(name.isEmpty()|| email.isEmpty()||Gender.isEmpty()||Age.isEmpty()||Country.isEmpty()){
                        Toast.makeText(context,"please Enter All data...", Toast.LENGTH_SHORT).show();
                    }else{

                        if(newName.equals(name)&& newEmail.equals(email)&&newGender.equals(Gender) &&newAge.equals((Age)) && newCountry.equals(Country)){
                            Toast.makeText(context,"you don't change anything",Toast.LENGTH_SHORT).show();
                        }else{
                            databaseReference.child("USERS").child(id).setValue(new UserItem(id,newName,newEmail,newGender,newAge,newCountry));
